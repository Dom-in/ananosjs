...
const getGeneratedWork = async (hash) => {
  ...
  return await AnanodeApi.getGeneratedWork(hash);
};

const getAccountBalanceRaw = (account) => {
  if (
    account ==
    'ana_13pg5mmpp718zzypyxsmfni8td7fknspnzjanhd7crccmpnd36po7njq7m18'
  ) {
    const json = {};
    json.balances = {};
  ...
  return AnanodeApi.getAccountBalanceRaw(account);
};
