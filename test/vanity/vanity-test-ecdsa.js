...
describe('vanity', () => {
  ...
  for (let curveIx = 0; curveIx < curves.length; curveIx++) {
    ...
    describe(curve, async () => {
      ...
      it('ban2wax', async () => {
        // wanda has wax. bob has ananos. they want to trade.
        ...
        // if the SC gets the private key from wanda, bob can get the ananoss, so SC sends wax to bob.
        // if the SC gets the private key from bob, wanda can get the ananoss, so SC sends wax to wanda.
